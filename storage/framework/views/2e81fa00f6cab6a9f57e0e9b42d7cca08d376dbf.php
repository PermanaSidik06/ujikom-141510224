...
<a href="<?php echo e(url('/tunjangan_pegawai/create')); ?>"class="btn btn-primary form-control">Tambah Data</a><br><br>
	...
	<tbody>
		...
		<tr>
            ...
            <td><center><?php echo e($tunjangan_pegawais->pegawaiModel->jabatanModel->nama_jabatan); ?></center></td>
            <td><center><?php echo e($tunjangan_pegawais->pegawaiModel->golonganModel->nama_golongan); ?></center></td>
