...
<center>
        <div class="col-md-8">
<center><h1>Data Lembur Karyawan</center></h1>
...
<br><br>
	...
	<tbody>
		...
		<tr>
			...
			<td><center><?php echo e($lembur_pegawais->kategori_lemburModel->kode_lembur); ?></center></td>
            ...
            <th><center><?php echo 'Rp.'. number_format($lembur_pegawais->kategori_lemburModel->besaran_uang*$lembur_pegawais->jumlah_jam,
                                    2,",","."); ?></center>
